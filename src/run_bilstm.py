...
HYPERPARAMETERS_PATH = Path('hyperparameters/bilstm.json')
MODEL_PATH = Path('models/bilstm.pt')
...
def main():
    ...
    config_summary = {
        'model': 'BiLSTM',
        'tokenizer': CONFIG.transformer.model,
    ...
    print(f'  Tokenizer:         {CONFIG.transformer.model}')
    ...
    for epoch in range(CONFIG.epochs):
        ...
        train_loss, train_acc = train_one_epoch(device, model, criterion, optimiser, train_dataloader)
